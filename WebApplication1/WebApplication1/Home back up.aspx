...
<asp:Content ID="Links" ContentPlaceHolderID="MenuLinks" runat="server">
    ...
    <%
    	...
    	'ConnectionString = "Server=BBARNETT-DELL\TREELOGGER;Database=KissFreak;User Id=ODBC;Password=BrIaN32[];"
    	ConnectionString = "Server=KissFreakApp.db.11812707.hostedresource.com;Database=KissFreakApp;User Id=KissFreakApp;Password=ODbc32#@!;"
        		...
        		Select Case ContentPageStyle
        			...
        			Case "Left"
        				...
        				Do While dr.Read
        					...
        					If dr.Item("IMGLinkContentPage") = "None" Then
        						ContentBlock += "<a target=""_blank"" href=""Javascript:window.open('/picture.aspx?Picture=" & dr.Item("FilePath").ToString.Replace("\", "FSL").Replace("/", "FSL") & "','menubar=0,scrollbars=0,width=700,height=750')""><img style=""text-align:left"" src=""" & dr.Item("FilePath") & """></a><br>"
        						
        					Else
        						ContentBlock += "<a href=""home.aspx?Page=" & dr.Item("IMGLinkContentPage") & """><img style=""text-align:left"" src=""" & dr.Item("FilePath") & """></a><br>"
        					End If
        					'ContentBlock += "<td>"
        					'ContentBlock += "</tr>"
        					'ContentBlock += "<tr>"
        			...
        			Case "Right"
        				...
        				Do While dr.Read
        					...
        					If dr.Item("IMGLinkContentPage") = "None" Then
        						ContentBlock += "<a target=""_blank"" href=""Javascript:window.open('/picture.aspx?Picture=" & dr.Item("FilePath").ToString.Replace("\", "FSL").Replace("/", "FSL") & "','menubar=0,scrollbars=0,width=700,height=750')""><img style=""text-align:right"" src=""" & dr.Item("FilePath") & """></a><br>"
        					Else
        						ContentBlock += "<a href=""home.aspx?Page=" & dr.Item("IMGLinkContentPage") & """><img src=""" & dr.Item("FilePath") & """></a><br>"
        					End If
        					'ContentBlock += "</td>"
        					'ContentBlock += "</tr>"
        					'ContentBlock += "<tr width=""100%"" style=""text-align:Right"">"
        			...
        			Case "Top"
        				...
        				Do While dr.Read
        					...
        					ContentBlock += "<td>"
        					If dr.Item("IMGLinkContentPage") = "None" Then
        						ContentBlock += "<a target=""_blank"" href=""Javascript:window.open('/picture.aspx?Picture=" & dr.Item("FilePath").ToString.Replace("\", "FSL").Replace("/", "FSL") & "','menubar=0,scrollbars=0,width=700,height=750')""><img style=""text-align:left"" height=""250"" width=""250"" src=""" & dr.Item("FilePath") & """></a><br>"
        					Else
        						ContentBlock += "<a href=""home.aspx?Page=" & dr.Item("IMGLinkContentPage") & """><img src=""" & dr.Item("FilePath") & """></a><br>"
        					End If
        					'ContentBlock += "<td>"
        			...
        			Case "Tiles"
        				...
        				Do While dr.Read
        					...
        					ContentBlock += "<td>"
        					If dr.Item("IMGLinkContentPage") = "None" Then
        						ContentBlock += "<a target=""_blank"" href=""Javascript:window.open('/picture.aspx?Picture=" & dr.Item("FilePath").ToString.Replace("\", "FSL").Replace("/", "FSL") & "','menubar=0,scrollbars=0,width=700,height=750')""><img style=""text-align:left"" width=""250"" height=""250"" src=""" & dr.Item("FilePath") & """></a><br>"
        					Else
        						ContentBlock += "<a href=""home.aspx?Page=" & dr.Item("IMGLinkContentPage") & """><img width=""250"" height=""250"" src=""" & dr.Item("FilePath") & """></a><br>"
        					End If
        					ContentBlock += dr.Item("Caption") & ""
        					ContentBlock += "</td>"
        				...
        				Do While dr.Read
        					...
        					If switchcounter = 0 Then
        						...
        						If dr.Item("IMGLinkContentPage") = "None" Then
        							ContentBlock += "<a target=""_blank"" href=""Javascript:window.open('/picture.aspx?Picture=" & dr.Item("FilePath").ToString.Replace("\", "FSL").Replace("/", "FSL") & "','menubar=0,scrollbars=0,width=700,height=750')""><img style=""text-align:left""  width=""250"" height=""250"" src=""" & dr.Item("FilePath") & """></a><br>"
        						Else
        							ContentBlock += "<a href=""home.aspx?Page=" & dr.Item("IMGLinkContentPage") & """><img style=""text-align:Left"" width=""250"" height=""250"" src=""" & dr.Item("FilePath") & """></a><br>"
        						End If
        					...
        					ElseIf switchcounter = 1 Then
        						...
        						If dr.Item("IMGLinkContentPage") = "None" Then
        							ContentBlock += "<a target=""_blank"" href=""Javascript:window.open('/picture.aspx?Picture=" & dr.Item("FilePath").ToString.Replace("\", "FSL").Replace("/", "FSL") & "','menubar=0,scrollbars=0,width=700,height=750')""><img style=""text-align:right""  width=""250"" height=""250"" src=""" & dr.Item("FilePath") & """></a><br>"
        						Else
        							ContentBlock += "<a href=""home.aspx?Page=" & dr.Item("IMGLinkContentPage") & """><img style=""text-align:right;padding:10px;""  width=""250"" height=""250"" src=""" & dr.Item("FilePath") & """></a><br>"
        						End If
